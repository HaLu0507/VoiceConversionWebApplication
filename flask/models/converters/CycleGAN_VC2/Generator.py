...
class Generator(nn.Module):
    def __init__(self):
        ...
        # 2D -> 1D Conv
        self.conv2dto1dLayer = nn.Sequential(nn.Conv1d(in_channels=5120, # 2304=9*256 -> 5120=20*256
                                                       out_channels=256,
                                                       kernel_size=1,
                                                       stride=1,
                                                       padding=0),
        ...
        self.conv1dto2dLayer = nn.Sequential(nn.Conv1d(in_channels=256,
                                                       out_channels=5120, # 2304=9*256 -> 5120=20*256
                                                       kernel_size=1,
                                                       stride=1,
                                                       padding=0),
                                             nn.InstanceNorm1d(num_features=5120, # 2304=9*256 -> 5120=20*256
                                                               affine=True))
    ...
    def forward(self, input):
        ...
        # 2D -> 1D
        # reshape
        reshape2dto1d = downsample2.view(downsample2.size(0), 5120, 1, -1) # 2304=9*256 -> 5120=20*256
        ...
        reshape1dto2d = reshape1dto2d.view(reshape1dto2d.size(0), 256, 20, -1) # 9=36/4 -> 20=80/4
